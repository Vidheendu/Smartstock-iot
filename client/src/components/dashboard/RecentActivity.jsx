    ...
    <div className="bg-white border border-[#D9E2EC] rounded-2xl p-6 shadow-xs space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-bold text-[#0F172A] tracking-tight">Recent Activity</h2>
        ...
        <div className="flex items-center gap-1.5 self-start sm:self-auto">
          <span className="text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-[#F8FAFC] text-[#64748B] border border-[#D9E2EC]">
      ...
      {activities.length === 0 ? (
        <div className="p-8 text-center border border-dashed border-[#D9E2EC] rounded-2xl space-y-2">
          <Inbox className="w-8 h-8 text-slate-400 mx-auto" />
          <p className="text-sm font-semibold text-[#0F172A]">No recent activity.</p>
          <p className="text-xs text-[#64748B]">
        ...
        <div className="divide-y divide-[#D9E2EC]">
          {activities.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="py-3.5 first:pt-1 last:pb-1 flex items-start gap-3.5 hover:bg-[#F8FAFC] transition rounded-xl px-2.5 -mx-2.5"
              >
