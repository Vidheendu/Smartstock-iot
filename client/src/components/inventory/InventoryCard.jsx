...
export const InventoryCard = ({
  ...
  return (
    <div className="bg-white border border-[#D9E2EC] rounded-2xl p-4 shadow-sm space-y-3">
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="space-y-0.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-slate-100 text-[#0F172A] border border-[#D9E2EC]">
              {item.category}
            </span>
          </div>
        </div>
      ...
      {/* Actions Row */}
      <div className="flex items-center justify-between gap-1 pt-1 border-t border-[#D9E2EC] text-xs">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-emerald-800 bg-[#D1FAE5] hover:bg-emerald-200 border border-emerald-300 rounded-lg transition cursor-pointer"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-[#1769C2] bg-[#E8F2FF] hover:bg-blue-100 border border-[#BFDBFE] rounded-lg transition cursor-pointer"
          >
