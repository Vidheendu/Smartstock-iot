    ...
    <div className="bg-white border border-[#D9E2EC] rounded-2xl p-4 sm:p-5 shadow-xs space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-center">
        ...
        <div className="lg:col-span-6 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-9 py-2 bg-[#F8FAFC] border border-[#D9E2EC] rounded-xl text-xs sm:text-sm text-[#0F172A] placeholder-[#64748B] focus:outline-none focus:border-[#1769C2] focus:ring-1 focus:ring-[#1769C2] transition"
          />
          {searchTerm && (
            <button
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-[#D9E2EC] text-xs text-[#64748B]">
        <div className="flex items-center gap-2">
          ...
          <span>
            Showing <strong className="text-[#0F172A] font-semibold">{filteredCount}</strong> of{' '}
            <strong className="text-[#0F172A] font-semibold">{totalCount}</strong> inventory items
          </span>
        </div>
        ...
        {isFiltered && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-semibold text-[#1769C2] hover:text-[#1257A0] bg-[#E8F2FF] hover:bg-[#dbeafe] rounded-lg transition cursor-pointer border border-[#BFDBFE]"
          >
            <X className="w-3.5 h-3.5" />
